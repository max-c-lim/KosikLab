...
recording_files = ["/home/maxlim/SpikeSorting/data/DL/recordings/maxone_2953.raw.h5"]  # adjust path based on where you store the data

# list of intermediate folder where tmp and output files are saved
intermediate_folders = ["/home/maxlim/SpikeSorting/data/DL/sorted/processed/maxone_2953/si"]  # adjust path based on where you store the data
